...
trigger = PSet(
    ...
    objectMatchesDoubleMuTrkPaths = r'matchToHLTPath({object_idx}, "HLT_DoubleMu7_v\\d+,HLT_Mu13_Mu8_v\\d+,HLT_Mu17_TkMu8_v\\d+")',
    objectMatchesMu17TrkMu8Paths = r'matchToHLTPath({object_idx}, "HLT_Mu17_TkMu8_v\\d+")',
    objectMatchesMu17TkMu8Paths = r'matchToHLTPath({object_idx}, "HLT_Mu17_TrkMu8_v\\d+")',
