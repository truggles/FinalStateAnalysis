...
mtToMET = PSet(
    ...
    objectMtToPfMet_tesUp  = 'mtMET({object_idx}, "", "pfmet", "tes+" , 1)',
    objectMtToPfMet_tesDown  = 'mtMET({object_idx}, "", "pfmet", "tes-" , 1)',
...
svfit = PSet(
    object1_object2_SVfitPt = 'SVfit({object1_idx},{object2_idx}, 0, 0).at(0)', # Last argument is verbosity
    object1_object2_SVfitEta = 'SVfit({object1_idx},{object2_idx}, 0, 0).at(1)', # and is optional
    object1_object2_SVfitPhi = 'SVfit({object1_idx},{object2_idx}, 0, 0).at(2)',
    object1_object2_SVfitMass = 'SVfit({object1_idx},{object2_idx}, 0, 0).at(3)',
